...
def main(index, idx):
  ...
  for _i in range(index):
    ...
    path = 'C:\\tmp_graph_output\\indexob{}_{}\\Image0001.png'.format(_i,idx)  # C:\tmp_graph_output
    ...
    path = 'C:\\tmp_graph_output\\indexob{}_{}\\'.format(_i,idx)  # C:\tmp_graph_output
    #os.system('rm -r {}'.format(path))
    os.system('del /S /Q {}'.format(path))
  #json.dump(obj_mask, open('/tmp/obj_mask_{}.json'.format(idx), 'w'))
  json.dump(obj_mask, open('.\\tmp\\obj_mask_{}.json'.format(idx), 'w'))
