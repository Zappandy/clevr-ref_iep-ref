# C:\Users\nanoa\Documents\LCT-Tasks\University of Malta\Applied NLP\clevr-refplus-dataset-gen\image_generation>C:\Users\nanoa\Documents\blender_install\blender --background --python restore_render_images.py -- --split train --width 480 --height 320 --use_gpu 0 --start_idx 0 --num_images 10 --clevr_scene_path .\train_input\CLEVR_scenes.json
...
def render_scene(args,
  ...
  #save_as_json
  cmd = ['C:\\Users\\nanoa\\anaconda3\envs\\blender_proj\\python','.\\restore_img2json.py', str(index), str(idx)] 
  ...
  obj_mask = json.load(open('.\\tmp\\obj_mask_{}.json'.format(idx)))
  _path = '.\\tmp\\obj_mask_{}.json'.format(idx)
  #os.system('rm ' + _path)
  os.system('del /Q ' + _path)
